        ...
        <div className="mt-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Advanced algorithms reduce file size while maintaining visual quality</p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Process multiple images simultaneously with batch compression</p>
            </div>
          </div>
        </div>
      </main>
